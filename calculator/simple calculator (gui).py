...
e=Entry(root,textvariable=input_text,width=40,borderwidth=5,font="Helvetica 8")
...
dlt=Button(root,text='Delete',fg='black', bg='gold',font=("Helvetica",10,'bold'), height=5, width=10,command=delete)
dlt.grid(row=1,column=3)
