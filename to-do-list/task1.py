...
def markcompleted():
    marked=listbox1.curselection()
    temp=marked[0]
    temp_marked=listbox1.get(marked)
    temp_marked=temp_marked+" ✔"
    listbox1.delete(temp)
    listbox1.insert(temp,temp_marked)
...
img5=PhotoImage(file="images/download (1).png")
Button(root,image=img5,bd=0,command=markcompleted).place(x=182,y=555)
label6=Label(root,text="Mark as complete",font="Helvetica 13",bg="#F6DDCC")
label6.place(x=140,y=600)
